<?php
namespace App\ALL_CRUD\ProfilePic;
class ProfilePic {
    public $id='';
    public $title='';
    public $profile_pic='';
    ...
    public function store(){
        ...
        $query="insert into profiles (id,title,profile_pic,created_at) values (null,'".$this->title."','".$this->profile_pic."','".$this->created_at."')";
    ...
    public function update($data=''){
        ...
        $query="update profiles set title='".$this->title."', profile_pic='".$this->profile_pic."' ,updated_at='".$this->updated_at."' where id=".$this->id;
        $result=mysqli_query($this->db, $query);
        }
        else{
            $query="update profiles set title='".$this->title."',updated_at='".$this->updated_at."' where id=".$this->id;
        $result=mysqli_query($this->db, $query);
        }
        if(!empty($result)){
            session_start();
    ...
    public function trash($data=''){
        ...
        $query="update profiles set deleted_at='".$this->deleted_at."' where id=".$this->id;
        $result=mysqli_query($this->db, $query);
        if(!empty($result)){
            session_start();
