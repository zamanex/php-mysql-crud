...
class Gender {
    ...
    public function store(){
        ...
        if(!empty($this->title)){
        $query="insert into gender (id,title,gender,created_at) values (null,'".$this->title."','".$this->gender."','".$this->created_at."')";
    ...
    public function delete($data=''){
        $this->id=$data['id'];
        $query="delete from gender where id=".$this->id;
        $result=mysqli_query($this->db, $query);
         if($result){
            session_start();
    ...
    public function update($data=''){
        ...
        $query="update gender set title='".$this->title."', gender='".$this->gender."' ,updated_at='".$this->updated_at."' where id=".$this->id;
        $result=mysqli_query($this->db, $query);
        if(!empty($result)){
            session_start();
    ...
    public function trash($data=''){
        ...
        $query="update gender set deleted_at='".$this->deleted_at."' where id=".$this->id;
        $result=mysqli_query($this->db, $query);
        if(!empty($result)){
            session_start();
