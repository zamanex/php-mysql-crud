...
class City {
    ...
    public function store(){
        ...
        if(!empty($this->title)){
        $query="insert into cities (id,title,city,created_at) values (null,'".$this->title."','".$this->city."','".$this->created_at."')";
    ...
    public function update($data=''){
        ...
        $query="update cities set title='".$this->title."', city='".$this->city."' ,updated_at='".$this->updated_at."' where id=".$this->id;
        $result=mysqli_query($this->db, $query);
        if(!empty($result)){
            session_start();
